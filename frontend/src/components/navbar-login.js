    ...
    return (
        <div className="font-sans">
            <div className="bg-black text-white">
                ...
                {/* Menu */}
                <div
                    className={`fixed top-50rem left-0 w-1/6 bg-white text-white transition-transform duration-300 shadow-2xl ${isMenuOpen ? "translate-x-0" : "-translate-x-full"
                        } h-[100vh] z-50`}
                >
                    ...
                    <a onClick={handleLogout} className="block px-6 text-black font-normal hover:underline cursor-pointer" style={{ position: 'relative', top: '450px' }}>Logout <span style={{ textDecoration: 'none' }}>-{'>'}</span></a>
                    ...
                    <div>
                        <a
                            ...
                            style={{ position: 'relative', top: '475px' }}
                        >
                        ...
                        <a
                            ...
                            style={{ position: 'relative', top: '476px' }}
                        >
                    ...
                    <p className="text-black font-light" style={{ position: 'relative' , top: '490px' , left: '25px'}}>02-555-2000 , 1111</p>
                </div>
            </div>
        </div>
    );
